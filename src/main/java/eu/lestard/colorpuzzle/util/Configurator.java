...
public class Configurator {
	...
	public static void setColorProfile(final ColorProfile profile) {
		Configurator.colorProfile = profile;
	}

	public static void setColorsCount(final int colorCount) {
	...
	public static void setAI(final ArtificialIntelligence ai) {
		Configurator.ai = ai;
	}
	...
	public static void setAiDelay(final int aiDelay) {
